...
Super simple CPU and memory monitoring for all workers.

## What It Does

Logs CPU and memory usage every 2 seconds:
```
...
### 2. Done!
Watch the logs - you'll see CPU and memory for each worker.
