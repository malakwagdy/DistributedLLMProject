...
Super simple CPU, memory, and GPU monitoring for all workers.

## What It Does

Logs CPU, memory, and GPU usage every 2 seconds:
```
...
### 2. Done!
Watch the logs - you'll see CPU, memory, and GPU for each worker.
